...
const builtinTools: ToolDefinition[] = [
  {
    ...
    parameters: [
      ...
      { name: 'maxLength', type: 'number', description: 'Maximum bytes to read (optional)', required: false },
    ],
  ...
  },
  {
    ...
    parameters: [
      ...
      { name: 'createDirs', type: 'boolean', description: 'Create parent directories if missing', required: false },
    ],
  ...
  },
  {
    ...
    parameters: [
      ...
      { name: 'timeoutMs', type: 'number', description: 'Execution timeout in ms', required: false },
    ],
